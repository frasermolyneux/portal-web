...
internal static class AuthorizationMatrix
{
    ...
    [
        ...
        Entry(AuthPolicies.GameServers_Admin_Rcon, GameType.CallOfDuty4, GameAdminAndAbove),
        Entry(AuthPolicies.GameServers_Admin_Rcon_Kick, null, AllAdmins),
    ...
    [
        ...
        Entry(AuthPolicies.GameServers_Admin_Rcon, PotentialAccessProbe.Instance, GameAdminAndAbove, "potential access"),
